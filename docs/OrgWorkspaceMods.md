...
> WorkspaceMod Install(ctx, orgHandle, workspaceHandle).CreateWorkspaceModRequest(createWorkspaceModRequest).Execute()
...
func main() {
    ...
    createWorkspaceModRequest := *openapiclient.NewCreateWorkspaceModRequest("Path_example") // CreateWorkspaceModRequest | The request body to install a mod in the mentioned workspace for this organization.

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.OrgWorkspaceMods.Install(context.Background(), orgHandle, workspaceHandle).CreateWorkspaceModRequest(createWorkspaceModRequest).Execute()
    if err != nil {
 ...
 **createWorkspaceModRequest** | [**CreateWorkspaceModRequest**](CreateWorkspaceModRequest.md) | The request body to install a mod in the mentioned workspace for this organization. | 
...
> WorkspaceMod Update(ctx, orgHandle, workspaceHandle, modAlias).UpdateWorkspaceModRequest(updateWorkspaceModRequest).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.OrgWorkspaceMods.Update(context.Background(), orgHandle, workspaceHandle, modAlias).UpdateWorkspaceModRequest(updateWorkspaceModRequest).Execute()
    if err != nil {
