...
func main() {
    ...
    request := *openapiclient.NewCreateWorkspaceSnapshotRequest(map[string][]openapiclient.WorkspaceSnapshotData{"key": "TODO"}) // CreateWorkspaceSnapshotRequest | The request body for the org workspace snapshot to be created.
