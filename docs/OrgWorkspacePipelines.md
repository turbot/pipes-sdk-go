...
> PipelineCommandResponse Command(ctx, orgHandle, workspaceHandle, pipelineId).PipelineCommandRequest(pipelineCommandRequest).Execute()
...
func main() {
    ...
    resp, r, err := api_client.OrgWorkspacePipelines.Command(context.Background(), orgHandle, workspaceHandle, pipelineId).PipelineCommandRequest(pipelineCommandRequest).Execute()
    if err != nil {
...
> Pipeline Create(ctx, orgHandle, workspaceHandle).CreatePipelineRequest(createPipelineRequest).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.OrgWorkspacePipelines.Create(context.Background(), orgHandle, workspaceHandle).CreatePipelineRequest(createPipelineRequest).Execute()
    if err != nil {
...
> Pipeline Update(ctx, orgHandle, workspaceHandle, pipelineId).UpdatePipelineRequest(updatePipelineRequest).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.OrgWorkspacePipelines.Update(context.Background(), orgHandle, workspaceHandle, pipelineId).UpdatePipelineRequest(updatePipelineRequest).Execute()
    if err != nil {
