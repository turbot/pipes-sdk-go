...
`func NewWorkspaceQueryResult(columns []WorkspaceQueryResultColumn, rows []map[string]map[string]interface{}, ) *WorkspaceQueryResult`
...
`func (o *WorkspaceQueryResult) GetRows() []map[string]map[string]interface{}`

GetRows returns the Rows field if non-nil, zero value otherwise.

### GetRowsOk

`func (o *WorkspaceQueryResult) GetRowsOk() (*[]map[string]map[string]interface{}, bool)`
...
`func (o *WorkspaceQueryResult) SetRows(v []map[string]map[string]interface{})`
