...
type OrgWorkspaceSchemasApiGetTableRequest struct {
	ctx             _context.Context
	ApiService      *OrgWorkspaceSchemasService
	orgHandle       string
	workspaceHandle string
...
func (r OrgWorkspaceSchemasApiGetTableRequest) Execute() (WorkspaceSchemaTable, *_nethttp.Response, error) {
	return r.ApiService.GetTableExecute(r)
}

/*
GetTable Get org workspace schema table

Get details about a specific table in a org workspace schema.

	@param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param orgHandle The handle of the org where the workspace belongs to.
	@param workspaceHandle The handle of the workspace where the schema exists.
	...
	@return OrgWorkspaceSchemasApiGetTableRequest
*/
func (a *OrgWorkspaceSchemasService) GetTable(ctx _context.Context, orgHandle string, workspaceHandle string, schemaName string, tableName string) OrgWorkspaceSchemasApiGetTableRequest {
	return OrgWorkspaceSchemasApiGetTableRequest{
		ApiService:      a,
		ctx:             ctx,
		orgHandle:       orgHandle,
...
func (a *OrgWorkspaceSchemasService) GetTableExecute(r OrgWorkspaceSchemasApiGetTableRequest) (WorkspaceSchemaTable, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrgWorkspaceSchemasService.GetTable")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/org/{org_handle}/workspace/{workspace_handle}/schema/{schema_name}/table/{table_name}"
	localVarPath = strings.Replace(localVarPath, "{"+"org_handle"+"}", _neturl.PathEscape(parameterToString(r.orgHandle, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"workspace_handle"+"}", _neturl.PathEscape(parameterToString(r.workspaceHandle, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"schema_name"+"}", _neturl.PathEscape(parameterToString(r.schemaName, "")), -1)
...
type OrgWorkspaceSchemasApiListTablesRequest struct {
	ctx             _context.Context
	ApiService      *OrgWorkspaceSchemasService
	orgHandle       string
	workspaceHandle string
...
func (r OrgWorkspaceSchemasApiListTablesRequest) Execute() (ListWorkspaceSchemaTableResponse, *_nethttp.Response, error) {
	return r.ApiService.ListTablesExecute(r)
}

/*
ListTables List org workspace schema tables
...
List the tables for an org workspace schema.
	...
	@param workspaceHandle The handle of the workspace where the schema exists.
	@param schemaName The name of the schema whose detail needs to be fetched.
	@return OrgWorkspaceSchemasApiListTablesRequest
*/
func (a *OrgWorkspaceSchemasService) ListTables(ctx _context.Context, orgHandle string, workspaceHandle string, schemaName string) OrgWorkspaceSchemasApiListTablesRequest {
	return OrgWorkspaceSchemasApiListTablesRequest{
		ApiService:      a,
		ctx:             ctx,
		orgHandle:       orgHandle,
...
func (a *OrgWorkspaceSchemasService) ListTablesExecute(r OrgWorkspaceSchemasApiListTablesRequest) (ListWorkspaceSchemaTableResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrgWorkspaceSchemasService.ListTables")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
