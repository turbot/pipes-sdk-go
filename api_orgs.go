...
type OrgsApiGetPlanRequest struct {
	ctx        _context.Context
	ApiService *OrgsService
	orgHandle  string
}

func (r OrgsApiGetPlanRequest) Execute() (IdentityPlan, *_nethttp.Response, error) {
	return r.ApiService.GetPlanExecute(r)
}

/*
GetPlan Get org billing plan.

Get the current organization billing plan.

	@param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param orgHandle Specify the handle of the organization to retrieve the billing plan for.
	@return OrgsApiGetPlanRequest
*/
func (a *OrgsService) GetPlan(ctx _context.Context, orgHandle string) OrgsApiGetPlanRequest {
	return OrgsApiGetPlanRequest{
		ApiService: a,
		ctx:        ctx,
		orgHandle:  orgHandle,
...
//
//	@return IdentityPlan
func (a *OrgsService) GetPlanExecute(r OrgsApiGetPlanRequest) (IdentityPlan, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue IdentityPlan
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrgsService.GetPlan")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/org/{org_handle}/billing/plan"
	localVarPath = strings.Replace(localVarPath, "{"+"org_handle"+"}", _neturl.PathEscape(parameterToString(r.orgHandle, "")), -1)
...
type OrgsApiListUsageRequest struct {
	ctx        _context.Context
	ApiService *OrgsService
	orgHandle  string
	where      *string
...
// The SQL where filter you wish to apply to this request. The filter will be parsed and sanitised and checked against the supported columns for this API.
func (r OrgsApiListUsageRequest) Where(where string) OrgsApiListUsageRequest {
	r.where = &where
	return r
}

// The max number of items to fetch per page of data, subject to a min and max of 1 and 100 respectively. If not specified will default to 25.
func (r OrgsApiListUsageRequest) Limit(limit int32) OrgsApiListUsageRequest {
	r.limit = &limit
	return r
}

// When list results are truncated, next_token will be returned, which is a cursor to fetch the next page of data. Pass next_token to the subsequent list request to fetch the next page of data.
func (r OrgsApiListUsageRequest) NextToken(nextToken string) OrgsApiListUsageRequest {
	r.nextToken = &nextToken
	return r
}

func (r OrgsApiListUsageRequest) Execute() (ListUsageMetricsResponse, *_nethttp.Response, error) {
	return r.ApiService.ListUsageExecute(r)
}

/*
ListUsage List org usage

List all usage metrics for an org.

	@param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param orgHandle Specify the handle of the org whose constraints you want to retrieve.
	@return OrgsApiListUsageRequest
*/
func (a *OrgsService) ListUsage(ctx _context.Context, orgHandle string) OrgsApiListUsageRequest {
	return OrgsApiListUsageRequest{
		ApiService: a,
		ctx:        ctx,
		orgHandle:  orgHandle,
...
func (a *OrgsService) ListUsageExecute(r OrgsApiListUsageRequest) (ListUsageMetricsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrgsService.ListUsage")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/org/{org_handle}/usage"
	localVarPath = strings.Replace(localVarPath, "{"+"org_handle"+"}", _neturl.PathEscape(parameterToString(r.orgHandle, "")), -1)
