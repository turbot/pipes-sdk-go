...
type UserWorkspaceUsagesService service

type UserWorkspaceUsagesApiListRequest struct {
	ctx             _context.Context
	ApiService      *UserWorkspaceUsagesService
	userHandle      string
...
func (r UserWorkspaceUsagesApiListRequest) Where(where string) UserWorkspaceUsagesApiListRequest {
	r.where = &where
	return r
}
...
func (r UserWorkspaceUsagesApiListRequest) Limit(limit int32) UserWorkspaceUsagesApiListRequest {
	r.limit = &limit
	return r
}
...
func (r UserWorkspaceUsagesApiListRequest) NextToken(nextToken string) UserWorkspaceUsagesApiListRequest {
	r.nextToken = &nextToken
	return r
}

func (r UserWorkspaceUsagesApiListRequest) Execute() (ListIdentityUsageResponse, *_nethttp.Response, error) {
	return r.ApiService.ListExecute(r)
}

/*
List List user workspace usage
...
List the usage associated with a user workspace.
	...
	@return UserWorkspaceUsagesApiListRequest
*/
func (a *UserWorkspaceUsagesService) List(ctx _context.Context, userHandle string, workspaceHandle string) UserWorkspaceUsagesApiListRequest {
	return UserWorkspaceUsagesApiListRequest{
		ApiService:      a,
		ctx:             ctx,
...
func (a *UserWorkspaceUsagesService) ListExecute(r UserWorkspaceUsagesApiListRequest) (ListIdentityUsageResponse, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UserWorkspaceUsagesService.List")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/user/{user_handle}/workspace/{workspace_handle}/usage"
